...
class WordDictionary:
    ...
    def search(self, word: str) -> bool:
        ...
        for i, char in enumerate(word):
            if char == '.':
                ...
                return self.foundMatchingWord(variants, word[i+1:len(word)], cur)
    ...
    def foundMatchingWord(self, variants: List[TrieNode], word: str, root: TrieNode) -> bool:
    ...
    def traverseTrie(self, root: TrieNode, word: str) -> bool:
        ...
        for i, char in enumerate(word):
            if char == '.':
                ...
                return self.foundMatchingWord(newVariants, word[i+1:len(word)], cur)
            elif cur.children[ord(char)-97] is None:
                return False
            elif i + 1 == len(word):
                return cur.children[ord(char)-97].isLeaf()
